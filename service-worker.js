const CACHE='pesmac-live-v1';
const STATIC=[
  './','./index.html','./styles.css','./tournament-ui.css','./dashboard-ui.css','./team-logo.css',
  './app.js','./dashboard-ui.js','./ui.js','./data.js','./config.js','./supabase-client.js','./pwa.js',
