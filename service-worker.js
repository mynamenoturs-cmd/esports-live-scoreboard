const CACHE='pesmac-live-v17';
const STATIC=[
  './','./index.html','./live.html','./bracket.html','./overlay.html',
  './styles.css','./tournament-ui.css','./dashboard-ui.css','./statistics.css','./team-logo.css','./series-score.css','./pwa.css','./live-fix.css','./live-premium.css','./winner-splash.css','./winner-manual.css','./obs-celebration.css',
  './app.js','./dashboard-ui.js','./statistics.js','./live.js','./bracket.js','./overlay.js','./ui.js','./data.js','./config.js','./supabase-client.js','./pwa.js','./series-style-loader.js','./mlbb-series-control.js','./mlbb-result-public.js','./mlbb-only-admin.js','./mlbb-live-guard.js',
